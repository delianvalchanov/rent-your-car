...
export const ArticleSchema = yup.object().shape({
    ...
    price: yup.string().matches(pricePattern, { message: 'Price must be between 1$ and 1000$!' }).required('Field is required!'),
    bodyType: yup.string().required('Field is required!'),
    carImage: yup.string().required('Field is required!'),
    year: yup.string().matches(yearPattern, { message: 'Year must be between 1900-2023!' }).required('Field is required!'),
