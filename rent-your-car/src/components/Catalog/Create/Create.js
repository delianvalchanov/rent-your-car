    ...
    return (
        <section id={CreateCSS['create']}>
            <div className={CreateCSS.container}>
                <form className={CreateCSS.wrapper} onSubmit={handleSubmit} method="POST" autoComplete="off">
                    ...
                    <div className="row">
                        <div className="col-6">
                            <fieldset>
                                ...
                                <input
                                    value={values.model}
                                    className={errors.model && touched.model ? CreateCSS.inputerr : CreateCSS.carField}
                            ...
                            <fieldset>
                                ...
                                <select value={values.fuel}
                                    className={errors.fuel && touched.fuel ? CreateCSS.inputerr : CreateCSS.carField}
                            ...
                            <fieldset>
                                ...
                                <select value={values.bodyType}
                                    className={errors.bodyType && touched.bodyType ? CreateCSS.inputerr : CreateCSS.carField}
                                ...
                                {errors.bodyType && touched.bodyType && <p>{errors.bodyType}</p>}
                        ...
                        <div className="col-6">
                            <fieldset>
                                ...
                                <input value={values.year}
                                    className={errors.year && touched.year ? CreateCSS.inputerr : CreateCSS.carField}
                            ...
                            <fieldset>
                                ...
                                <input value={values.price}
                                    className={errors.price && touched.price ? CreateCSS.inputerr : CreateCSS.carField}
                            ...
                            <fieldset>
                                ...
                                <input value={values.carImage}
                                    className={errors.carImage && touched.carImage ? CreateCSS.inputerr : CreateCSS.carField}
                                    onChange={handleChange('carImage')}
                                    onBlur={handleBlur('carImage')}
                                    id="carImage"
                                    type="text"
                                    name="carImage" />
                                {errors.carImage && touched.carImage && <p>{errors.carImage}</p>}
                        ...
                        <div className="col-12">
                            <fieldset>
                                ...
                                <textarea value={values.description}
                                    className={errors.description && touched.description ? CreateCSS.inputerr : CreateCSS.carField}
                                    onChange={handleChange('description')}
                                    onBlur={handleBlur('description')}
                                    id="description"
                                    type="text"
                                    name="description" cols="2" rows="6">
                                </textarea>
